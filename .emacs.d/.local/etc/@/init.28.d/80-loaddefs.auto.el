...
(fn &optional PATH FORCE-P)" t nil)(autoload 'doom/copy-this-file "~/.emacs.d/lisp/lib/files" "Copy current buffer's file to NEW-PATH then open NEW-PATH.
...
(fn MODES &rest BACKENDS)" nil nil) (function-put 'set-company-backend! 'lisp-indent-function 'defun))(put 'set-company-backend! 'doom-module '(:completion . company))(autoload '+vertico/embark-magit-status "~/.emacs.d/modules/completion/vertico/autoload/magit" "Run `magit-status` on repo containing the embark target.
...
targets." nil nil)(autoload '+vertico--consult--fd-make-builder "~/.emacs.d/modules/completion/vertico/autoload/vertico" nil nil nil)(autoload '+vertico/consult-fd "~/.emacs.d/modules/completion/vertico/autoload/vertico" "
...
(fn &rest _)" nil nil)(autoload '+popup--init "~/.emacs.d/modules/ui/popup/autoload/popup" "Initializes a popup window. Run any time a popup is opened. It sets the
...
(fn _)" nil nil)(autoload '+workspaces-save-tab-bar-data-to-file-h "~/.emacs.d/modules/ui/workspaces/autoload/workspaces" "Save the current workspace's tab bar data to file.

(fn &rest _)" nil nil)(autoload '+workspaces-load-tab-bar-data-h "~/.emacs.d/modules/ui/workspaces/autoload/workspaces" "Restores the tab bar data of the workspace we have just switched to.

(fn _)" nil nil)(autoload '+workspaces-load-tab-bar-data-from-file-h "~/.emacs.d/modules/ui/workspaces/autoload/workspaces" "Restores the tab bar data from file.

(fn &rest _)" nil nil)(autoload '+workspaces-autosave-real-buffers-a "~/.emacs.d/modules/ui/workspaces/autoload/workspaces" "Don't autosave if no real buffers are open.

(fn FN &rest ARGS)" nil nil)(autoload '+file-templates--expand "~/.emacs.d/modules/editor/file-templates/autoload" "Auto insert a yasnippet snippet into current file and enter insert mode (if
...
(fn OV)" nil nil)(autoload 'set-yas-minor-mode! "~/.emacs.d/modules/editor/snippets/autoload/settings.el" "Register minor MODES (one mode symbol or a list of them) with yasnippet so it
...
(fn MODES &key WORDS CHARS)" nil nil) (function-put 'set-electric! 'lisp-indent-function 'defun))(put 'set-electric! 'doom-module '(:emacs . electric))(autoload 'browse-at-remote--format-region-url-as-codeberg "~/.emacs.d/modules/emacs/vc/autoload/vc" "URL formatted for codeberg.

(fn REPO-URL LOCATION FILENAME &optional LINESTART LINEEND)" nil nil)(autoload 'browse-at-remote--format-commit-url-as-codeberg "~/.emacs.d/modules/emacs/vc/autoload/vc" "Commit URL formatted for codeberg

(fn REPO-URL COMMITHASH)" nil nil)(autoload '+vc/browse-at-remote "~/.emacs.d/modules/emacs/vc/autoload/vc" "Open URL to current file (and line if selection is active) in browser.
...
(fn BEG END)" t nil)(autoload '+eval/open-repl-same-window "~/.emacs.d/modules/tools/eval/autoload/repl" "Opens (or reopens) the REPL associated with the current major-mode and place
...
Used by `+lookup/in-docsets' and `+lookup/documentation'." (ignore modes docsets))(put 'set-docsets! 'doom-module '(:tools . lookup))(autoload '+lookup/definition "~/.emacs.d/modules/tools/lookup/autoload/lookup" "Jump to the definition of IDENTIFIER (defaults to the symbol at point).
...
(fn &optional PARSE-START)" nil nil)(autoload '+markdown-flyspell-word-p "~/.emacs.d/modules/lang/markdown/autoload" "Return t if `flyspell' should check word before point.
...
(fn &optional DEFAULT CONTEXT)" nil nil)(autoload '+org-link--var-link-activate-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn START END VAR BRACKETED-P)" nil nil)(autoload '+org-link--fn-link-activate-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn START END FN BRACKETED-P)" nil nil)(autoload '+org-link--face-link-activate-face "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn START END FACE BRACKETED-P)" nil nil)(autoload '+org-link--command-link-activate-command "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn START END COMMAND BRACKETED-P)" nil nil)(autoload '+org-link--doom-module-link-follow-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn MODULE-PATH ARG)" nil nil)(autoload '+org-link--doom-module-link-face-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn MODULE-PATH)" nil nil)(autoload '+org-link--doom-module-link-activate-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn START END MODULE-PATH BRACKETED-P)" nil nil)(autoload '+org-link--doom-package-link-activate-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn START END PACKAGE BRACKETED-P)" nil nil)(autoload '+org-link-follow-doom-package-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "TODO

(fn PKG PREFIXARG)" nil nil)(autoload '+org-link--doom-executable-link-activate-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "

(fn START END EXECUTABLE BRACKETED-P)" nil nil)(autoload '+org-image-file-data-fn "~/.emacs.d/modules/lang/org/autoload/org-link" "Intepret LINK as an image file path and return its data.
  ...
  (set-formatter! 'elm-format
    ...
    (lambda (output errput first-diff)
      (list output
            ...
            first-diff)))" (ignore name formatter modes filter ok-statuses error-regexp))(put 'set-formatter! 'doom-module '(:editor . format))(defmacro set-evil-initial-state! (modes state) "THIS FUNCTION DOES NOTHING BECAUSE (:editor . evil) IS DISABLED

Set the initialize STATE of MODES using `evil-set-initial-state'." (ignore modes state))(put 'set-evil-initial-state! 'doom-module '(:editor . evil))(put 'flyspell-mode! 'doom-module '(:checkers . spell))(defalias 'flyspell-mode! #'ignore "THIS FUNCTION DOES NOTHING BECAUSE (:checkers . spell) IS DISABLED
