...
% Die Ueberschrift ist echt blöd gewählt...
% \section{Der erste Abschnitt des ersten Anhangs}
% Nach einer Ueberschrift kommt bekanntlich immer Text.
%
% \begin{figure}
%     \centering
%     \includegraphics[width=1\linewidth]{images/statistic_id2984_fahrleistung-von-pkw-in-deutschland-bis-2019.pdf}
%     \caption{Caption}
