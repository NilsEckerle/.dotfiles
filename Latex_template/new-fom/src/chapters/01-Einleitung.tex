%Literatur einfuegen     \cite[S.3]{bibkey} 
% In JabRef die zu zitierende Quelle auswaehlen und STRG+L (z.B. bei Verwendun von TeXstudio) oder STRG+K (hier wird direkt "\cite{bibkey}" kopiert) drücken. Dann mit STRG+V an der Stelle einfügen, an welcher man den Literaturverweis einfügen möchte.
...
% Zunaechst kommt ein einleitender Text...
...
% Dieses und jenes Thema wird in \autoref{sec:Kapitel3} naeher betrachtet...
