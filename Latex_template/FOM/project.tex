...
\input{latex/preamble/layout.tex}
\defbibheading{bibintoc}[\bibname]{%
  \addchap{#1}}
\input{latex/preamble/commands.tex}
...
\input{latex/preamble/title}

\input{latex/00-Zusammenfassung}
...
\listoftables
%\lstlistoflistings
\input{latex/abkuerzungen}
%-----------------------------------------------------------------------------%
% Sperrvermerk. Bitte möglichst nicht verwenden.                              %
%-----------------------------------------------------------------------------%
%\input{latex/Sperrvermerk}
...
\input{latex/01-Einleitung}

\input{latex/02-Kapitel2}

\input{latex/03-Kapitel3}

\input{latex/08-ZusammenfassungUndAusblick}
